...
var VERSION = 'gr52-e92062fe8a0d';
var PRECACHE = ["/", "/GR52_all-in-one.gpx", "/log.js?v=6806bac8a4", "/vendor/zip.min.js?v=a911c709c1", "/map.js?v=c84a856da9", "/trip.js?v=9a65a731ab", "/vendor/leaflet.min.js?v=5c9aecfc30", "/vendor/leaflet.min.css?v=b570abbda9", "/vendor/leaflet-rotate.umd.min.js?v=543dab62fe", "/vendor/leaflet-rotate.css?v=fde9c7ff97", "/vendor/images/layers.png", "/vendor/images/layers-2x.png", "/manifest.webmanifest", "/icon.svg", "/maps/authion.webp", "/maps/menton.webp", "/maps/merv.webp", "/maps/north.webp", "/maps/overview.webp"];
